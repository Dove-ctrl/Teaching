...
/* 
    ...
    假设没有颜色标注提示你，你不可能很快地读懂function_a在干什么，
    甚至有颜色标注时，你也不可能保证5秒内你能看清这个函数的大致结构，
    而反观function_b，阅读难度大大降低，明眼人一看就能知道在做什么，
    因此，我建议每个新人，敲代码不要着急，一定先把缩进格式写清楚，我很看重这个东西，
    缩进控制不对，证明你大概率不会写出什么好程序，优秀程序的缩进一定是控制得很规范的。
 */
...
/* 
    ...
    这当然不影响阅读,但是写代码也要考虑美观性,
    如果不控制一下整体风格,很容易让别人觉得你的代码是到处复制粘贴来的.
 */